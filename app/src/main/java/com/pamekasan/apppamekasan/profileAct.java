...
public class profileAct extends AppCompatActivity {
    ...
    LinearLayout btn_item_my_ticket;
    Button btn_edit_profile, btn_back_home, btn_log_out;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_item_my_ticket = findViewById(R.id.btn_item_my_ticket);
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Picasso.with(profileAct.this).load(dataSnapshot.child("url_photo_profile").getValue().toString()).centerCrop().fit().into(photo_home_user);
            }
        ...
        btn_edit_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gotoeditprofile = new Intent(profileAct.this, editProfile.class);
        ...
        btn_back_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent gobackhome = new Intent(profileAct.this, homeScreen.class);
        ...
        btn_log_out.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //menghapus isi dari username local
                SharedPreferences sharedPreferences =  getSharedPreferences(USERNAME_KEY, MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putString(username_key, null);
                editor.apply();

                Intent signout = new Intent(profileAct.this, signInB.class);
